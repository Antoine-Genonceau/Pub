...
public class Fenetre extends JFrame implements ActionListener {
	...
	public void affichejeux(Carte[] valpq) {
		...
		for (int v=0 ; v<x; v++){
			Fenetre.cartej0[v] = new ImageIcon ("image/"+valpq[v].figure.nom+valpq[v].couleur.nom+".gif");
		}		
		paneau.repaint();
	}
	//================================================
	...
	public void affichecarter(Carte valpq,String imatout) {
		this.carter = new ImageIcon("image/"+valpq.figure.nom+valpq.couleur.nom+".gif");
		this.atout=new ImageIcon("image/"+imatout+".gif");
		paneau.repaint();
	}
	//==========================================
	...
	public void affichej(Carte y,int u) {
		Fenetre.cartej[u] = new ImageIcon ("image/"+y.figure.nom+y.couleur.nom+".gif");
		paneau.repaint();
	}
	//=========================================
